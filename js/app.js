(() => {
    ...
    const contentComponent = document.querySelector(".content-component");
    if (panel) panelBtn.addEventListener("click", (function() {
        panel.classList.toggle("active");
        panelBtn.classList.toggle("active");
        content.classList.toggle("active");
        contentComponent.classList.toggle("active");
        if (content.classList.contains("active")) content.addEventListener("click", (function() {
            panel.classList.remove("active");
            panelBtn.classList.remove("active");
            content.classList.remove("active");
            contentComponent.classList.remove("active");
        }));
    }));
